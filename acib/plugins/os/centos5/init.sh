os_centos5_plugin_usage() {
	usage_section "CentOS 5"
	
	usage_description "This plugin installs a minimal CentOS 5.x."
...
register_usage "os_centos5_plugin_usage"
...
uninstall_packages_from_target() {
	run_in_target yum remove -y "$@" | spin "Uninstalling $*"
}
